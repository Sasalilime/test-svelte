...
var app = (function () {
    ...
    var CustomStore = customStoreBox();
    ...
    // (81:4) {#each data as box (box.id)}
    function create_each_block$1(key_1, ctx) {
    	let div;
    	let h2;
    	let t0_value = /*box*/ ctx[13].text + "";
    	let t0;
    	let t1;
    	let h3;
    	let t2_value = /*box*/ ctx[13].id + "";
    	let t2;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			h3 = element("h3");
    			t2 = text(t2_value);
    			add_location(h2, file$c, 82, 12, 1889);
    			add_location(h3, file$c, 83, 12, 1921);
    			add_location(div, file$c, 81, 8, 1871);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*data*/ 2 && t0_value !== (t0_value = /*box*/ ctx[13].text + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*data*/ 2 && t2_value !== (t2_value = /*box*/ ctx[13].id + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(81:4) {#each data as box (box.id)}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	childtoparent.$on("info-carte", /*fonctionParent*/ ctx[10]);
    ...
    function create_contenu_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			p = element("p");
    			p.textContent = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, consequuntur corporis\n                            debitis\n                            eligendi\n                            eum hic minus, nemo, omnis reprehenderit similique totam vero voluptas voluptatibus\n                            voluptatum?";
    			add_location(p, file$c, 114, 24, 2922);
    			attr_dev(div, "slot", "contenu");
    			add_location(div, file$c, 113, 20, 2877);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(114:20) <div slot=\\\"contenu\\\">",
    		ctx
    	});
    ...
    // (112:16) <ChildToParent on:info-carte={fonctionParent}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			add_location(h2, file$c, 112, 20, 2821);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(112:16) <ChildToParent on:info-carte={fonctionParent}>",
    		ctx
    	});
    ...
    // (130:12) {#if toggleModal}
    function create_if_block$2(ctx) {
    	let modal;
    	let current;
    	modal = new Modal({ $$inline: true });
    	modal.$on("overlayModal", /*handleModal*/ ctx[11]);
    ...
    function create_fragment$c(ctx) {
    	...
    	validate_each_argument(each_value);
    	const get_key = ctx => /*box*/ ctx[13].id;
    	validate_each_keys(ctx, each_value, get_each_context$1, get_key);

    	for (let i = 0; i < each_value.length; i += 1) {
    		let child_ctx = get_each_context$1(ctx, each_value, i);
    		let key = get_key(child_ctx);
    		each0_lookup.set(key, each_blocks[i] = create_each_block$1(key, child_ctx));
    	}

    	const list1_spread_levels = [{ class: "p-1" }, { montitre: /*titre*/ ctx[5] }, /*myObject*/ ctx[6]];
    	let list1_props = {};
    	...
    	each1 = new Each({ props: { class: "p-1" }, $$inline: true });
    	...
    	let if_block0 = /*toggle*/ ctx[3] && create_if_block_1$1(ctx);
    	let if_block1 = /*toggleModal*/ ctx[4] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			create_component(each1.$$.fragment);
    			t15 = space();
    			div2 = element("div");
    			...
    			add_location(h1, file$c, 86, 4, 1970);
    			add_location(p, file$c, 90, 25, 2109);
    			add_location(button0, file$c, 91, 12, 2139);
    			add_location(button1, file$c, 92, 12, 2192);
    			add_location(button2, file$c, 93, 12, 2245);
    			attr_dev(div0, "class", "p-1");
    			add_location(div0, file$c, 90, 8, 2092);
    			attr_dev(div1, "class", "flex justify-around");
    			add_location(div1, file$c, 88, 4, 1990);
    			attr_dev(div2, "class", "flex justify-around");
    			add_location(div2, file$c, 100, 4, 2402);
    			add_location(h2, file$c, 108, 12, 2595);
    			attr_dev(button3, "class", "my-1");
    			add_location(button3, file$c, 109, 12, 2636);
    			add_location(div3, file$c, 107, 8, 2577);
    			attr_dev(div4, "class", "flex justify-around");
    			add_location(div4, file$c, 105, 4, 2506);
    			attr_dev(button4, "class", "my-1");
    			add_location(button4, file$c, 128, 12, 3407);
    			add_location(div5, file$c, 127, 8, 3389);
    			add_location(div6, file$c, 133, 8, 3603);
    			attr_dev(div7, "class", "flex justify-around");
    			add_location(div7, file$c, 126, 4, 3347);
    			add_location(main, file$c, 75, 0, 1806);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, t14);
    			mount_component(each1, div1, null);
    			append_dev(main, t15);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button2, "click", /*reset*/ ctx[9], false, false, false),
    					listen_dev(button3, "click", /*click_handler*/ ctx[12], false, false, false),
    					listen_dev(button4, "click", /*handleModal*/ ctx[11], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*data*/ 2) {
    				...
    				validate_each_argument(each_value);
    				validate_each_keys(ctx, each_value, get_each_context$1, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each0_lookup, main, destroy_block, create_each_block$1, t1, get_each_context$1);
    			}

    			if (!current || dirty & /*txt*/ 1) set_data_dev(t2, /*txt*/ ctx[0]);

    			const list1_changes = (dirty & /*titre, myObject*/ 96)
    			? get_spread_update(list1_spread_levels, [
    					list1_spread_levels[0],
    					dirty & /*titre*/ 32 && { montitre: /*titre*/ ctx[5] },
    					dirty & /*myObject*/ 64 && get_spread_object(/*myObject*/ ctx[6])
    				])
    			: {};

    			list1.$set(list1_changes);
    			if (!current || dirty & /*compteur*/ 4) set_data_dev(t5, /*compteur*/ ctx[2]);
    			...
    			if (/*toggleModal*/ ctx[4]) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);

    					if (dirty & /*toggleModal*/ 16) {
    		...
    		i: function intro(local) {
    			...
    			transition_in(each1.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(each1.$$.fragment, local);
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	const increment = () => {
    		$$invalidate(2, compteur++, compteur);
    	};
    	...
    	const handleModal = () => {
    		$$invalidate(4, toggleModal = !toggleModal);
    	};
    	...
    	const click_handler = () => $$invalidate(3, toggle = !toggle);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("titre" in $$props) $$invalidate(5, titre = $$props.titre);
    		if ("myObject" in $$props) $$invalidate(6, myObject = $$props.myObject);
    		if ("compteur" in $$props) $$invalidate(2, compteur = $$props.compteur);
    		if ("toggle" in $$props) $$invalidate(3, toggle = $$props.toggle);
    		if ("toggleModal" in $$props) $$invalidate(4, toggleModal = $$props.toggleModal);
    	};
