...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 5, 0, 42);
    			add_location(li0, file, 7, 4, 92);
    			add_location(li1, file, 8, 4, 113);
    			add_location(li2, file, 9, 4, 134);
    			add_location(li3, file, 10, 4, 155);
    			add_location(li4, file, 11, 4, 176);
    			attr_dev(ul, "class", "text-red-500");
    			add_location(ul, file, 6, 0, 62);
    		},
    ...
    class List1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { montitre: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 23, 4, 320);
    			add_location(button0, file$1, 24, 4, 346);
    			add_location(button1, file$1, 25, 4, 391);
    			add_location(button2, file$1, 26, 4, 436);
    			add_location(main, file$1, 20, 0, 281);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button2, "click", /*reset*/ ctx[4], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [compteur, titre, increment, decrement, reset];
    }
